    ...
    public class cMatrix
    {
      ...
      public double[] A
      {
        get
        {
          ...
          double dy = kk[1];
          double dz = kk[2];
          return this.FindAngle(dy, dz);
        }
      }

      /// <summary>
      /// rXrYrZFixedAngle returns a 3 x 2 matrix.  Column one is one solution, Column two is the other.
      /// Utilize your axis limits to determine the correct solution for this case.  This is the 
      /// Orientation relative to the fixed world coordinate system and I really don't think this works.
      /// </summary>
      public double[,] rXrYrZFixedAngle //rotation about X, Y and then Z
      {
        get
        {
          ...
          double rZ = Math.Atan2(i[1] / cosb, i[0] / cosb);
          double rX = Math.Atan2(j[2] / cosb, k[2] / cosb);
      ...
      public double[] B
      {
        get
        {
          ...
          double dx = kk[0];
          double dz = kk[2];
          double[] ret = this.FindAngle(dx, dz);
          ret[0] = 360 - ret[0];
          ret[1] = -ret[1];
          return ret;
        }
...
//        return this.myXfroms.DotProduct(start - 1, finish - 1);
      ...
      public string[] ToString()
      {
        ...
        positions.Add(" A: " + A[1].ToString("F4").PadLeft(10));
        positions.Add(" B: " + B[1].ToString("F4").PadLeft(10));
